...
import io.github.deechtezeeuw.crazemcwidm.gui.ColorPanel;
...
public class DeathNote extends GraphicalUserInterface {
    ...
    public void open(Player player) {
        ...
        lore.add(ChatColor.translateAlternateColorCodes('&', "&8>> &7Klik op deze speler om hem/haar dood te maken"));
        int place = 10;
    ...
    @Override
    public String title() {
        return plugin.getConfigManager().getMain().serverPrefix + plugin.getConfigManager().getMain().serverDivider + "&4&lDeathnote";
    }
