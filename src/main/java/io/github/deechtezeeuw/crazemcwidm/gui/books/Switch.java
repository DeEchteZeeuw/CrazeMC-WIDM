...
public class Switch extends GraphicalUserInterface {
    ...
    public void open(Player player) {
        ...
        lore.add(ChatColor.translateAlternateColorCodes('&', "&8>> &7Klik op deze speler om te ruilen van plek"));
        int place = 10;
    ...
    @Override
    public String title() {
        return plugin.getConfigManager().getMain().serverPrefix + plugin.getConfigManager().getMain().serverDivider + "&2&lSwitch";
    }
