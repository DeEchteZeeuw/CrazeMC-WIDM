...
public class Booklock extends GraphicalUserInterface {
    ...
    public void open(Player player) {
        ...
        lore.add(ChatColor.translateAlternateColorCodes('&', "&8>> &7Klik op deze speler om hem/haar een book lock te geven"));
        int place = 10;
    ...
    @Override
    public String title() {
        return plugin.getConfigManager().getMain().serverPrefix + plugin.getConfigManager().getMain().serverDivider + "&7&lBook lock";
    }
