...
public class ItemClear extends GraphicalUserInterface {
    ...
    public void openPlayer(Player player, Player choosen) {
        ...
        lore = new ArrayList<>();
        lore.add(ChatColor.translateAlternateColorCodes('&', "&8>> &7Klik om &b&l" + choosen.getName() + " &7zijn wapens(s) te verwijderen!"));
        gui.setItem(13, this.menuItem("&e&lWapen(s)", "DIAMOND_SWORD", 1, 0, lore));
        lore = new ArrayList<>();
        lore.add(ChatColor.translateAlternateColorCodes('&', "&8>> &7Klik om &b&l" + choosen.getName() + " &7zijn book(s) te verwijderen!"));
    ...
    public void open(Player player) {
        ...
        ArrayList<String> lore = new ArrayList<>();
        lore.add(ChatColor.translateAlternateColorCodes('&', "&8>> &7Klik op deze speler om zijn/haar items te kiezen om te verwijderen"));
        int place = 10;
    ...
    @Override
    public String title() {
        return plugin.getConfigManager().getMain().serverPrefix + plugin.getConfigManager().getMain().serverDivider + "&f&lItemclear";
    }
