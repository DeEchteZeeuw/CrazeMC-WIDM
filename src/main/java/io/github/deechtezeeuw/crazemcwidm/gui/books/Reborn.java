...
public class Reborn extends GraphicalUserInterface {
    ...
    public void open(Player player) {
        ...
        lore.add(ChatColor.translateAlternateColorCodes('&', "&8>> &7Klik op deze speler om hem/haar levend te maken"));
        int place = 10;
        for (Contestant contestant : deadPlayers) {
    ...
    @Override
    public String title() {
        return plugin.getConfigManager().getMain().serverPrefix + plugin.getConfigManager().getMain().serverDivider + "&6&lReborn";
    }
