...
public class PKCheck extends GraphicalUserInterface {
    ...
    public void open(Player player) {
        ...
        lore.add(ChatColor.translateAlternateColorCodes('&', "&8>> &7Klik op deze speler om te kijken of hij/zij de Peacekeeper is!"));
        int place = 10;
    ...
    @Override
    public String title() {
        return plugin.getConfigManager().getMain().serverPrefix + plugin.getConfigManager().getMain().serverDivider + "&1&lPK Check";
    }
