...
public class Gui extends Config {
    ...
    public Integer rolesSize;
    public String rolesBackgroundMaterial;
    ...
    // Blocks GUI
    public String blocksTitle;
    public Integer blocksSize;
    public String blocksBackgroundMaterial;
    ...
    public void load() {
        ...
        rolesTitle = config.getString("gui.roles.title");
        rolesSize = config.getInt("gui.roles.size");
        rolesBackgroundMaterial = config.getString("gui.roles.background.material");
        ...
        blocksTitle = config.getString("gui.blocks.title");
        blocksSize = config.getInt("gui.blocks.size");
        blocksBackgroundMaterial = config.getString("gui.blocks.background.material");
